...
try:
  api_id = int(environ["20989170"])
  api_hash = environ["cf7ba9b38839e542f88130abad09b0b8"]
  bot_token = environ.get("6588610499:AAFLd49AIeE8N4RMWiY-Y0oukm6HekpT1IU", None)
  tg_session = environ.get("TELEGRAM_SESSION", None)
  sudo_users = list(set(x for x in environ.get("SUDO_USERS", "999197022").split(";")))
  try:
    from_chats = list(set(int(x) for x in environ.get("-1001284268486").split()))
    to_chats = list(set(int(x) for x in environ.get("-1002131352116").split()))
